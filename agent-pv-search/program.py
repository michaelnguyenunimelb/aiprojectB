...
def minimax(board, frogs, color, depth, alpha, beta, storebest=None):
    ...
    if color == Cell.RED:
        ...
        for m in moves:
            ...
            new_eval = 0
            if foundPV:
                new_eval = minimax(board, frogs, switch_color(color), depth-1, alpha, alpha+0.01)
        ...
        for m in moves:
            ...
            new_eval = 0
            if foundPV:
                new_eval = minimax(board, frogs, switch_color(color), depth-1, beta-0.01, beta)
                if new_eval > alpha and new_eval < beta:
                    new_eval = minimax(board, frogs, switch_color(color), depth-1, alpha, beta)
            else:
                new_eval = minimax(board, frogs, switch_color(color), depth-1, alpha, beta)
