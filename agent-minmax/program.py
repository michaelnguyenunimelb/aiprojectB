...
class Agent:
    ...
    def action(self, **referee: dict) -> Action:
        ...
        storedmove = []
        minimax(self.board, self.frogs, cellcolor, 4, storedmove)
...
def minimax(board, frogs, color, depth, storebest=None):
    if depth == 0:
    ...
    if color == Cell.RED:
        ...
        for m in moves:
            ...
            new_eval = minimax(board, frogs, switch_color(color), depth-1)
